import { getTodayWeather } from '../services/gameRules';

export function WeatherBanner() {
  const weather = getTodayWeather();

  return (
    <div className={`pixel-grid rounded-2xl border-4 border-white bg-gradient-to-r ${weather.color} p-5 shadow-soft`}>
