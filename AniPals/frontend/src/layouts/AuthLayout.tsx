...
import farmPreview from '../assets/farm-preview.png';
  ...
  return (
    <main className="min-h-screen bg-cream pixel-grid px-4 py-8 text-ink">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl items-center justify-center">
        <div
          className="grid w-full overflow-hidden rounded-3xl border-4 border-white bg-white/70 shadow-soft lg:grid-cols-[1fr_440px]"
        >
          <section className="relative min-h-[420px] bg-gradient-to-br from-meadow via-lime-200 to-pond p-8">
            <img
              src={farmPreview}
              alt="Pixel farm preview"
              className="mx-auto block h-auto max-h-[360px] w-full border-4 border-white shadow-pixel"
            />
